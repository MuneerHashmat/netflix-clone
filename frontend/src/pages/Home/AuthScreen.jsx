  ...
  return (
    <div className="hero-bg relative w-full overflow-x-hidden">
      <header className="max-w-6xl mx-auto flex items-center justify-between p-4 pb-10">
        ...
        <Link
          to={"/login"}
          className="text-white bg-red-600 py-1 px-2 rounded hover:bg-red-700"
        >
          Sign In
        </Link>
      </header>
      ...
      {/* hero section */}
      <div className="flex px-4 flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto">
      ...
      <div className="py-10 bg-black text-white">
        <div className="flex flex-col md:flex-row items-center justify-center mx-auto px-4 md:px-2 max-w-6xl">
          {/* left side */}
